...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "MOHAN_musicBot")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5174683280").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/RRomeo-RJ/Romeo-musicBot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/mohaan_filims23")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Bashaal26")
